...
like['inmodel']  = 'stacked_models_iem_add3_ext5+fb.xml'
like['outmodel'] = 'stacked_results_iem_add3_ext5+fb.xml'
like["debug"]    = debug
like.execute()
...
resmap['inmodel']    = 'stacked_results_iem_add3_ext5+fb.xml'
resmap['modcube']    = 'NONE'
resmap['outmap']     = 'resmap_iem_add3_ext5+fb.fits'
