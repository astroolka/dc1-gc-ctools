...
like['inmodel']  = 'stacked_models_iem_add1_ext.xml'
like['outmodel'] = 'stacked_results_iem_add1_ext.xml'
like["debug"]    = debug
like.execute()
...
resmap['inmodel']    = 'stacked_results_iem_add1_ext.xml'
resmap['modcube']    = 'NONE'
resmap['outmap']     = 'resmap_iem_add1_ext.fits'
